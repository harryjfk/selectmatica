...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.logger.profiling.rest' => 'getDoctrine_Dbal_Logger_Profiling_RestService',
            'doctrine.dbal.rest_connection' => 'getDoctrine_Dbal_RestConnectionService',
            ...
            'doctrine.orm.rest_entity_listener_resolver' => 'getDoctrine_Orm_RestEntityListenerResolverService',
            'doctrine.orm.rest_entity_manager' => 'getDoctrine_Orm_RestEntityManagerService',
            'doctrine.orm.rest_listeners.attach_entity_listeners' => 'getDoctrine_Orm_RestListeners_AttachEntityListenersService',
            'doctrine.orm.rest_manager_configurator' => 'getDoctrine_Orm_RestManagerConfiguratorService',
            'doctrine.orm.validator.unique' => 'getDoctrine_Orm_Validator_UniqueService',
            'doctrine.orm.validator_initializer' => 'getDoctrine_Orm_ValidatorInitializerService',
            'doctrine_cache.providers.doctrine.orm.default_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.default_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.default_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultResultCacheService',
            'doctrine_cache.providers.doctrine.orm.rest_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_RestMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.rest_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_RestQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.rest_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_RestResultCacheService',
            ...
            'ps_pdf.request_listener' => 'getPsPdf_RequestListenerService',
            ...
            'seguridad.listener' => 'getSeguridad_ListenerService',
            ...
            'store.paginator_aware' => 'getStore_PaginatorAwareService',
        ...
        $this->aliases = array(
            ...
            'doctrine.orm.rest_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.rest_metadata_cache',
            'doctrine.orm.rest_query_cache' => 'doctrine_cache.providers.doctrine.orm.rest_query_cache',
            'doctrine.orm.rest_result_cache' => 'doctrine_cache.providers.doctrine.orm.rest_result_cache',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Common\BaseAppBundle\EventListener\LocaleListener A Common\BaseAppBundle\EventListener\LocaleListener instance.
     */
    protected function getApp_LocaleListenerService()
    {
        return $this->services['app.locale_listener'] = new \Common\BaseAppBundle\EventListener\LocaleListener('en', $this->get('doctrine'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StoreStoreBundle', ($this->targetDirs[2].'/Resources/StoreStoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'StoreStoreBundle', ($this->targetDirs[3].'\\src\\Store\\StoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'ps_pdf.request_listener', 1 => 'onKernelRequest'), 0);
        $instance->addListenerService('security.interactive_login', array(0 => 'seguridad.listener', 1 => 'onSecurityInteractivelogin'), 0);
        ...
        $instance->addSubscriberService('app.locale_listener', 'Common\\BaseAppBundle\\EventListener\\LocaleListener');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'rest' => 'doctrine.dbal.rest_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'rest' => 'doctrine.orm.rest_entity_manager'), 'default', 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.rest_listeners.attach_entity_listeners'));
        $c->addEventListener(array(0 => 'postPersist', 1 => 'postRemove', 2 => 'postUpdate'), $this->get('seguridad.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'store', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }

    /**
     * Gets the 'doctrine.dbal.rest_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance.
     */
    protected function getDoctrine_Dbal_RestConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.rest'));
        ...
        return $this->services['doctrine.dbal.rest_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => 'http://localhost:8081/andromeda-ws/rest/', 'port' => 5555, 'user' => 'ADMIN', 'password' => 'admin', 'driver' => 'pdo_mysql', 'driverOptions' => array('CURLOPT_HTTPHEADER' => ''), 'driverClass' => 'Circle\\DoctrineRestDriver\\Driver', 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Store\\StoreBundle\\Resources\\config\\doctrine') => 'Store\\StoreBundle\\Entity', ($this->targetDirs[3].'\\src\\Common\\AdminBaseBundle\\Resources\\config\\doctrine') => 'Common\\AdminBaseBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Store\\StoreBundle\\Entity');
        $b->addDriver($a, 'Common\\AdminBaseBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Common\\SeguridadBundle\\Entity'))), 'Common\\SeguridadBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('StoreStoreBundle' => 'Store\\StoreBundle\\Entity', 'CommonSeguridadBundle' => 'Common\\SeguridadBundle\\Entity', 'CommonAdminBaseBundle' => 'Common\\AdminBaseBundle\\Entity'));
    ...
    /**
     * Gets the 'doctrine.orm.rest_entity_listener_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Mapping\DefaultEntityListenerResolver A Doctrine\ORM\Mapping\DefaultEntityListenerResolver instance.
     */
    protected function getDoctrine_Orm_RestEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.rest_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }

    /**
     * Gets the 'doctrine.orm.rest_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_RestEntityManagerService()
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Store\\RestBundle\\Resources\\config\\doctrine') => 'Store\\RestBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Store\\RestBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('StoreRestBundle' => 'Store\\RestBundle\\Entity'));
        $c->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.rest_metadata_cache'));
        $c->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.rest_query_cache'));
        $c->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.rest_result_cache'));
        $c->setMetadataDriverImpl($b);
        $c->setProxyDir((__DIR__.'/doctrine/orm/Proxies'));
        $c->setProxyNamespace('Proxies');
        $c->setAutoGenerateProxyClasses(true);
        ...
        $c->setQuoteStrategy($this->get('doctrine.orm.quote_strategy.default'));
        $c->setEntityListenerResolver($this->get('doctrine.orm.rest_entity_listener_resolver'));

        $this->services['doctrine.orm.rest_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.rest_connection'), $c);

        $this->get('doctrine.orm.rest_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.rest_listeners.attach_entity_listeners' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\Tools\AttachEntityListenersListener A Doctrine\ORM\Tools\AttachEntityListenersListener instance.
     */
    protected function getDoctrine_Orm_RestListeners_AttachEntityListenersService()
    {
        return $this->services['doctrine.orm.rest_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener();
    }

    /**
     * Gets the 'doctrine.orm.rest_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_RestManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.rest_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b7074060e6012584a704a78c8df2b208ca6445333dabe807b4bd2fdee728eea3');
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.rest_metadata_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_RestMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.rest_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();

        $instance->setNamespace('sf2orm_rest_b7074060e6012584a704a78c8df2b208ca6445333dabe807b4bd2fdee728eea3');

        return $instance;
    }

    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.rest_query_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_RestQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.rest_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    /**
     * Gets the 'doctrine_cache.providers.doctrine.orm.rest_result_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\Common\Cache\ArrayCache A Doctrine\Common\Cache\ArrayCache instance.
     */
    protected function getDoctrineCache_Providers_Doctrine_Orm_RestResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.rest_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'CommonBaseAppBundle:Default:_pag_sliding.html.twig', 'defaultSortableTemplate' => 'CommonBaseAppBundle:Default:_sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 10));
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('thumb_200x150' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 200, 1 => 150), 'mode' => 'outbound', 'allow_upscale' => true)), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('rest', $this->get('doctrine.dbal.logger.profiling.rest'));
    ...
    {
        return $this->services['ps_pdf.cache'] = new \PHPPdf\Cache\CacheImpl('File', array('cache_dir' => __DIR__));
    }
    ...
    /**
     * Gets the 'ps_pdf.request_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ps\PdfBundle\EventListener\PdfRequestListener A Ps\PdfBundle\EventListener\PdfRequestListener instance.
     */
    protected function getPsPdf_RequestListenerService()
    {
        return $this->services['ps_pdf.request_listener'] = new \Ps\PdfBundle\EventListener\PdfRequestListener();
    }
    ...
    protected function getPunkAve_FileUploaderService()
    {
        ...
        return $this->services['punk_ave.file_uploader'] = $this->scopedServices['request']['punk_ave.file_uploader'] = new \PunkAve\FileUploaderBundle\Services\FileUploader(array('file_base_path' => ($this->targetDirs[2].'/../web/uploads'), 'web_base_path' => 'http://localhost:8080/store/web/uploads/', 'request' => $this->get('request'), 'file_manager' => $this->get('punk_ave.file_uploader_file_manager'), 'allowed_extensions' => array(0 => 'gif', 1 => 'png', 2 => 'jpg', 3 => 'jpeg', 4 => 'pdf', 5 => 'mp3', 6 => 'xls', 7 => 'ppt', 8 => 'doc', 9 => 'pptx', 10 => 'sldx', 11 => 'ppsx', 12 => 'potx', 13 => 'xlsx', 14 => 'xltx', 15 => 'docx', 16 => 'dotx', 17 => 'txt', 18 => 'rtf', 19 => 'zip'), 'sizes' => array('thumbnail' => array('folder' => 'thumbnails', 'max_width' => 80, 'max_height' => 80), 'small' => array('folder' => 'small', 'max_width' => 320, 'max_height' => 480), 'medium' => array('folder' => 'medium', 'max_width' => 640, 'max_height' => 960), 'large' => array('folder' => 'large', 'max_width' => 1140, 'max_height' => 1140)), 'originals' => array('folder' => 'originals'), 'max_number_of_files' => NULL, 'max_file_size' => NULL));
    }
    ...
    {
        return $this->services['punk_ave.file_uploader_file_manager'] = new \PunkAve\FileUploaderBundle\Services\FileManager(array('file_base_path' => ($this->targetDirs[2].'/../web/uploads')));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Common\\SeguridadBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 15))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/seguridad/login');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/seguridad/register');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/seguridad/create');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/seguridad/logout');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('/frame');
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, 'seguridad_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'seguridad_logout'));
        ...
        $r->setOptions(array('login_path' => 'seguridad_login', 'default_target_path' => 'store_homepage', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $r->setProviderKey('admin');

        $s = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $p, array(), $a);
        $s->setOptions(array('login_path' => 'seguridad_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'admin', $a, $d), 2 => $q, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $p, 'admin', $r, $s, array('check_path' => 'seguridad_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57f7b9ee27a2c0.33221392', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker'), 'admin', $h, $a, '_switch_user', 'ROLE_USER', $d), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $o, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $p, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $p, 'seguridad_login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'seguridad.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Common\SeguridadBundle\Listener\LogListener A Common\SeguridadBundle\Listener\LogListener instance.
     */
    protected function getSeguridad_ListenerService()
    {
        return $this->services['seguridad.listener'] = new \Common\SeguridadBundle\Listener\LogListener($this);
    }
    ...
    /**
     * Gets the 'store.paginator_aware' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Store\StoreBundle\Services\PaginatorAware A Store\StoreBundle\Services\PaginatorAware instance.
     */
    protected function getStore_PaginatorAwareService()
    {
        $this->services['store.paginator_aware'] = $instance = new \Store\StoreBundle\Services\PaginatorAware();

        $instance->setPaginator($this->get('knp_paginator'));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'StoreStoreBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\punkave\\symfony2-file-uploader-bundle\\PunkAve\\FileUploaderBundle/Resources/views'), 'PunkAveFileUploader');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Store\\StoreBundle/Resources/views'), 'StoreStore');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\psliwa\\pdf-bundle\\Ps\\PdfBundle/Resources/views'), 'PsPdf');
        $instance->addPath(($this->targetDirs[3].'\\src\\Store\\RestBundle/Resources/views'), 'StoreRest');
        $instance->addPath(($this->targetDirs[3].'\\src\\Common\\SeguridadBundle/Resources/views'), 'CommonSeguridad');
        $instance->addPath(($this->targetDirs[3].'\\src\\Common\\AdminBaseBundle/Resources/views'), 'CommonAdminBase');
        $instance->addPath(($this->targetDirs[3].'\\src\\Common\\BaseAppBundle/Resources/views'), 'CommonBaseApp');
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_RestService()
    {
        return $this->services['doctrine.dbal.logger.profiling.rest'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin', 'seguridad_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Common\\SeguridadBundle\\Entity\\Usuario', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'StoreStoreBundle' => 'Store\\StoreBundle\\StoreStoreBundle',
                'PsPdfBundle' => 'Ps\\PdfBundle\\PsPdfBundle',
                'StoreRestBundle' => 'Store\\RestBundle\\StoreRestBundle',
                'KnpSnappyBundle' => 'Knp\\Bundle\\SnappyBundle\\KnpSnappyBundle',
                'CommonSeguridadBundle' => 'Common\\SeguridadBundle\\CommonSeguridadBundle',
                'CommonAdminBaseBundle' => 'Common\\AdminBaseBundle\\CommonAdminBaseBundle',
                'CommonBaseAppBundle' => 'Common\\BaseAppBundle\\CommonBaseAppBundle',
            ...
            'rest_name' => NULL,
            'locale' => 'en',
            'upload_images_dir' => ($this->targetDirs[2].'/../web/uploads/images/'),
            'upload_temp_dir' => ($this->targetDirs[2].'/../web/uploads/tmp/attachments/'),
            'upload_images_web' => 'http://localhost:8080/store/web/uploads//images/',
            'server_dir' => 'http://localhost:8080/store/web',
            'options_upload_web' => 'http://localhost:8080/store/web/uploads/options/',
            'user_upload_web' => 'http://localhost:8080/store/web/uploads/users/',
            ...
            'doctrine.entity_managers' => array(
                ...
                'rest' => 'doctrine.orm.rest_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'rest' => 'doctrine.dbal.rest_connection',
            ),
            ...
            'file_uploader.max_file_size' => NULL,
            'file_uploader.file_base_path' => ($this->targetDirs[2].'/../web/uploads'),
            'file_uploader.web_base_path' => 'http://localhost:8080/store/web/uploads/',
            ...
            'knp_paginator.template.pagination' => 'CommonBaseAppBundle:Default:_pag_sliding.html.twig',
            'knp_paginator.template.filtration' => 'KnpPaginatorBundle:Pagination:filtration.html.twig',
            'knp_paginator.template.sortable' => 'CommonBaseAppBundle:Default:_sortable_link.html.twig',
            ...
            'store.paginator_aware.class' => 'Store\\StoreBundle\\Services\\PaginatorAware',
