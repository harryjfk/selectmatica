...
class SimpleImage {
    ...
    public static function Resizes($src,$dest,$dim)
    {
    ...
    public static function ResizesToWidth($src,$dest,$width)
    {
        $image = new SimpleImage();
        $image->load($src);
    ...
    public static function ResizesToHeight($src,$dest,$height)
    {
        $image = new SimpleImage();
        $image->load($src);
